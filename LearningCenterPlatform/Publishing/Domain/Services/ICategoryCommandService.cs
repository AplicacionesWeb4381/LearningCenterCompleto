...
public interface ICategoryCommandService
{
    ...
    /// <summary>
    ///     Handles the update category command in the ACME Learning Center Platform.
    /// </summary>
    /// <param name="command">
    ///     The <see cref="UpdateCategoryCommand" /> command to handle.
    /// </param>
    /// <returns>
    ///     The updated <see cref="Category" /> entity.
    /// </returns>
